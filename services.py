    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[{
                ...
                "system",
                "content":
                """You are a helpful assistant that extracts breadcrumb navigation trails from text.
                A breadcrumb is a horizontally arranged series of text links separated by the "forward slash" symbol (/).
                Examples:
                ...
                "user",
                "content":
                f"Extract or create a relevant breadcrumb trail from the following text:\n\n{text}"
            }],
            max_tokens=200)
